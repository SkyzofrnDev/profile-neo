...
const Stats = () => {
  return (
    <div className="py-7 md:py-15 px-10 md:px-28 bg-dark font-semibold text-white">
      <div className="flex flex-col lg:gap-y-7 lg:flex-row w-full h-full justify-between items-center ">
        ...
        <div className="bg-white/50 rotate-90 lg:rotate-0 h-20 w-0.5 rounded-full lg:bg-white z-10"></div>
        <div className="flex flex-col justify-center items-center md:gap-y-5">
        ...
        <div className="bg-white/50 rotate-90 lg:rotate-0 h-20 w-0.5 rounded-full lg:bg-white"></div>
