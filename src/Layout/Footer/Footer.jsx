...
const Footer = () => {
  ...
  return (
    <div className="bg-white mt-18 lg:mt-0 px-7 lg:px-20 pb-10 pt-7 lg:pt-20 lg:mx-5 lg:rounded-[4rem]">
      <div>
        <p className="font-bold text-3xl lg:text-6xl leading-tight jakarta">
      ...
      <div className="w-full mt-5 lg:mt-15 px-28 h-0.5 bg-black/5 lg:bg-[#8f8f8f] rounded-full"></div>
